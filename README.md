...
**Use of Data**
With user consent via the in-app Reconsent screen, data may be used for:
...
**Consent Requirement**
All analytics and personalized recommendations through the CDP are processed only after explicit user consent. If you do not consent, behavioral data remains anonymous and unlinked, and only essential operational data is processed.
